...
namen_lijst = ["Joel","Laura","Senna"]

print(f"Hallo ik ben {namen_lijst[0]}")
print("{0} is mijn naam en de naam van mijn vrouw is {1}".format(namen_lijst[0],namen_lijst[1]))
print("Mijn naam is " + namen_lijst[0] + " mijn vrouw heet " + namen_lijst[1] + " en de naam van onze pleegdochter is " + namen_lijst[2])

# Opdracht 7B

letterList = ['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', 'l', 'k', 'j', 'h', 'g', 'f', 'd', 's', 'a', 'z', 'x', 'c', 'v', 'b', 'n', 'm']
zin = "Hallo ik ben Joel en ik zit bij Hacklab"
uiteindelijke_zin = ""
